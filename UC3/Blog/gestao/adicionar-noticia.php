                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="p-5">
                            <div class="text-center">
                                <h1 class="h4 text-gray-900 mb-4">Cadastrar Notícia</h1>
                            </div>
                            <form class="user">
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        Selecione uma imagem: <input style="border: none;padding: 0;border-radius: 0;" type="file" class="form-control form-control-user" id="imagem" name="imagem"
                                        >
                                    </div>
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control form-control-user"
                                            id="fonte" name="fonte" placeholder="Fonte">
                                    </div>
                                </div>
                                <div class="form-group">
